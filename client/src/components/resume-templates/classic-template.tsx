...
export function ClassicTemplate({ content, allowOverflow = false }: ClassicTemplateProps) {
  return (
    <div 
      className={`resume-preview bg-white p-8 w-[816px] font-serif ${allowOverflow ? '' : 'h-[1056px] overflow-hidden'}`}
