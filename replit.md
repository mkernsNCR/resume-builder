...
- **PDF Generation**: PDFKit server rendering with template-aware typography,
  selectable text, and entry-aware pagination
...
- **PDFKit**: Generates compact, selectable-text PDFs on the server
- **Entry-aware pagination**: Keeps section headings and resume entries together when space allows
